class WelcomeController < ApplicationController
  ...
  def index
    ...
    @posts_approved_1 = Category.find("student-life").posts.published.limit(3).reject{|p| @posts_approved_0.include? p}
    @posts_approved_2 = Category.find("opinion").posts.published.limit(3).reject{|p| @posts_approved_0.include? p}
    @posts_approved_3 = Category.find("culture").posts.published.limit(3).reject{|p| @posts_approved_0.include? p}
    @posts_approved_4 = Category.find("lifestyle").posts.published.limit(6).reject{|p| @posts_approved_0.include? p}
