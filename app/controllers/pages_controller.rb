class PagesController < ApplicationController
  ...
  def team
    set_meta_tags title: 'About us',
                  description:
                    'We believe that teen magazines should be inclusive and focus on topics written by, and important to, teens.'
  end
  ...
  def subscribe
    set_meta_tags title: 'The Teen Magazine | 2021 September Issue',
                  ...
                  image:
                    'https://s3.amazonaws.com/media.theteenmagazine.com/September+2021.png',
                  fb: {
                    app_id: '1190455601051741'
                  },
                  og: {
