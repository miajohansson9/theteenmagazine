...
(function () {
  ...
  g.prototype = {
    ...
    _matchElement: function (a) {
      return this.options.cssSelector && l && a.$[l](this.options.cssSelector)
        ? a
        : null;
    },
        ...
        (CKEDITOR.ui.balloonToolbarView.prototype.renderItems = function (a) {
          ...
          CKEDITOR.tools.array.forEach(
            ...
            function (e) {
              ...
              a[e] instanceof CKEDITOR.ui.richCombo &&
              d
