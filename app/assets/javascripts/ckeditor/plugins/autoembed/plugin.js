...
(function () {
  ...
  CKEDITOR.plugins.add("autoembed", {
    ...
    lang: "ar,az,bg,ca,cs,da,de,de-ch,el,en,en-au,eo,es,es-mx,et,eu,fa,fr,gl,hr,hu,it,ja,km,ko,ku,lt,lv,mk,nb,nl,oc,pl,pt,pt-br,ro,ru,sk,sq,sr,sr-latn,sv,tr,ug,uk,vi,zh,zh-cn",
    init: function (a) {
      var g = 1,
        b;
      a.on(
