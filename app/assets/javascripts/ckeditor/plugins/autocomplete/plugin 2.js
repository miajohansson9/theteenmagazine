...
(function () {
  ...
  e.prototype = {
    attach: function () {
      var a = this.editor,
        ...
        c = a.editable(),
        d = c.isInline() ? c : c.getDocument();
      CKEDITOR.env.iOS &&
        !c.isInline() &&
        (d = a.window.getFrame().getParent());
      this.view.append();
      this.view.attach();
      ...
      c && this.registerPanelNavigation();
      a.on(
        "contentDom",
        function () {
  ...
  g.prototype = {
    ...
    setPosition: function (a) {
      var b = this.editor,
        ...
        e = b.bottom - a.bottom,
        f;
      f = a.top < b.top ? b.top : Math.min(b.bottom, a.bottom);
      c > e && c < d && (f = a.top - c);
      b.bottom < a.bottom && (f = Math.min(a.top - c, b.bottom - c));
      b.top > a.top && (f = Math.max(a.bottom, b.top));
      this.element.setStyles({ left: a.left + "px", top: f + "px" });
    },
  ...
  CKEDITOR.plugins.autocomplete = e;
  e.view = g;
  e.model = h;
