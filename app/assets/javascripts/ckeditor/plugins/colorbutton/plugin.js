...
(function () {
    ...
    init: function (a) {
      function b(d) {
        ...
        function A(d, x, e) {
          ...
          d && (c.color = d);
          x && (c.colorName = x);
          x = !CKEDITOR.tools.isEmpty(c) && new CKEDITOR.style(b(), c);
          a.execCommand(m, { newStyle: x });
          if (d && e)
            for (
        ...
        var B = new CKEDITOR.style(r["colorButton_" + h + "Style"]),
          q = CKEDITOR.tools.getNextId() + "_colorBox",
          y = { type: h },
          z = new CKEDITOR.style(r["colorButton_" + h + "Style"], {
            color: "inherit",
          }),
          w = (function () {
          ...
          u = l.getRowLimit(a)
            ? new l(a, "back" == h ? "background-color" : "color", w)
            : void 0,
          t;
        a.addCommand(m, {
          contextSensitive: !0,
          ...
          refresh: function (a, d) {
            z.checkApplicable(d, a, a.activeFilter)
              ? z.checkActive(d, a)
        ...
        a.ui.add(g, CKEDITOR.UI_PANELBUTTON, {
          ...
          panel: {
            ...
            attributes: { role: "listbox", "aria-label": n.panelTitle },
          },
          select: function (a) {
          ...
          onBlock: function (d, b) {
            ...
            b.element.setHtml(c(q, w, u ? u.getLength() : 0));
          ...
          onOpen: function () {
            ...
            if (e) {
              ...
              if ((b = d && d.getRanges()[0])) {
                ...
                "transparent" == b && (b = "");
                "fore" == h && (y.automaticTextColor = "#" + p(e));
                y.selectionColor = b ? "#" + b : "";
                v(t, b);
              }
              return e;
            }
      ...
      function c(b, c, f) {
        ...
        for (b = 0; b < h.length; b++) {
          ...
          var m = h[b].split("/"),
            v = m[0],
            m = new q(a, { color: m[1] || v, label: m[1] ? v : void 0 }, c);
          m.setPositionIndex(p + b, f);
          g.push(m.getHtml());
        }
      ...
      function v(a, b) {
        ...
        if (f) f.setAttribute("aria-selected", !0);
          ...
          for (g = 0; g < c.count(); g++)
            if (
              ((f = c.getItem(g)), b && b == p(f.getAttribute("data-value")))
            ) {
      ...
      var r = a.config,
        n = a.lang.colorbutton;
      if (!CKEDITOR.env.hc) {
        b({
          name: "TextColor",
          type: "fore",
          commandName: "textColor",
          title: n.textColorTitle,
          order: 10,
        ...
        var k,
          w = a.config.colorButton_normalizeBackground;
        if (void 0 === w || w)
          k = [
            [
              {
  ...
  q = CKEDITOR.tools.createClass({
    $: function (a, b, c) {
      ...
      this.clickFn = c;
      this.label = b.label || q.colorNames(a)[this.color] || this.color;
      this.setHtml();
    },
    statics: {
  ...
  l = CKEDITOR.tools.createClass({
    ...
    _: {
      ...
      getHexCode: function (a, b, c) {
        ...
        return f in c
          ? c[f].substr(1)
          : this._.normalizeColor(a.getComputedStyle(b)).toUpperCase();
      },
      ...
      createAtBeginning: function (a) {
        this._.moveToBeginning(new q(this.editor, { color: a }, this.clickFn));
      },
      addNewRow: function () {
