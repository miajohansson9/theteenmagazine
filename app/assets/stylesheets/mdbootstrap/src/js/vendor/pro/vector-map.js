...
Array.prototype.indexOf ||
    ...
    (jvm.NumericScale.prototype = {
        ...
        getValue: function(value) {
            ...
            for (
                ...
                (fullLength += l);
            for (
                c = (this.maxValue - this.minValue) / fullLength, i = 0; i < lengthes.length; i++
            )
                lengthes[i] *= c;
                ...
                case "r":
                    jvm
                        ...
                        .css({
                            ...
                            border: this.map.params.markerStyle.initial["stroke-width"] +
                                "px " +
    ...
    (jvm.Region = function(config) {
        ...
        (this.shape = config.canvas.addPath({ d: config.path, "data-code": config.code },
            config.style,
    ...
    (jvm.Map = function(params) {
        var e,
            map = this;
        if (
            ((this.params = jvm.$.extend(!0, {}, jvm.Map.defaultParams, params)), !jvm.Map.maps[this.params.map])
        )
            throw new Error(
    ...
    (jvm.Map.prototype = {
                ...
                this.container.delegate(
                    ...
                    function(e) {
                        var baseVal =
                            ...
                            type = -1 === baseVal.indexOf("jvectormap-region") ?
                            "marker" :
                            "region",
                            code = jvm
                            .$(this)
        ...
        setFocus: function(config) {
            ...
            if (
                ...
                return this.setScale(
                    Math.min(this.width / bbox.width, this.height / bbox.height), -(bbox.x + bbox.width / 2), -(bbox.y + bbox.height / 2), !0,
                    config.animate
                );
            }
            return (
        ...
        createRegions: function() {
            ...
            for (key in this.mapData.paths)
                (region = new jvm.Region({
                    ...
                    label: "vml" != this.canvas.mode ?
                        this.params.labels && this.params.labels.regions : null,
                })),
        ...
        createMarkers: function(markers) {
            ...
            if (
                ...
                for (
                    markersArray = markers.slice(), markers = {}, i = 0; i < markersArray.length; i++
                )
            ...
            for (i in markers)
                ...
                ((marker = new jvm.Marker({
                        ...
                        label: "vml" != this.canvas.mode ?
                            this.params.labels && this.params.labels.markers : null,
                    })),
        ...
        addMarkers: function(markers, seriesData) {
            var i;
            for (
                seriesData = seriesData || [], this.createMarkers(markers), i = 0; i < seriesData.length; i++
            )
        ...
        addMap: function(name, config) {
            ...
            return (
                ...
                this.maps[name].container.on(
                    "regionClick.jvectormap", { scope: this },
                    function(e, code) {
