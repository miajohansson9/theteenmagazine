  ...
  function ClockPicker(element, options) {
    ...
    if (options.twelvehour) {
      ...
      const togglePeriod = (period) => {
        ...
        self.amOrPm = period;
        self.amPmBlock
          .children(`.${previsiousPeriod}-button`)
          .removeClass("active");
        self.amPmBlock
          .children(`.${period.toLowerCase()}-button`)
          .addClass("active");
    ...
    $(
      '<button type="button" class="btn btn-flat clockpicker-button done-button" tabindex="' +
    ...
    $(
      '<button type="button" class="btn btn-flat clockpicker-button clear-button" tabindex="' +
