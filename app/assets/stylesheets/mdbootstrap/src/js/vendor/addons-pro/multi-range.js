...
(($) => {
  class mdbRange {
    constructor(range, options) {
      ...
      this.$rangeWrapper = this.$range.parent().hasClass("multi-range-field")
        ? this.$range.parent()
        : null;
    ...
    addThumb() {
      ...
      this.options.direction === "horizontal"
        ? this.$rangeWrapper.addClass("thumb-horizontal-wrapper")
        : null;
    }
    ...
    rangeChange() {
      this.$range.on("change", (e) => {
        ...
        this.options.single.value !== undefined
          ? $thumbValue.html(
              `${$etarget.val()} ${this.options.single.value.symbol}`
            )
          : $thumbValue.html($etarget.val());
      });
    }
    ...
    multiRangeInit() {
      this.$range.attr({
        ...
        step:
          this.options.single.value !== undefined
            ? this.options.single.value.step
            : this.defaults.single.value.step,
        symbol:
          this.options.single.value !== undefined
            ? this.options.single.value.symbol
            : this.defaults.single.value.symbol,
      });
      ...
      this.$range.on("input mousedown touchstart", (e) => {
        ...
        if (e.type !== "input") {
          ...
          if (page === undefined || page === null) {
            ...
            this.options.direction === "horizontal"
              ? originalEventTouch
              : (originalEventTouch = e.originalEvent.touches[0].pageX);
        ...
        if ($etarget.hasClass("ghost")) {
          ...
          $thumb.css(
            "background-color",
            this.options.single.bgThumbColor === undefined
              ? this.defaults.single.bgThumbColor
              : this.options.single.bgThumbColor
          );
          $thumb
            .children()
            .css(
              "color",
              this.options.single.textThumbColor === undefined
                ? this.defaults.single.textThumbColor
                : this.options.single.textThumbColor
            );
        }
        ...
        this.options.single.value !== undefined
          ? $thumb
              .find(".value")
              .html(`${$etarget.val()} ${this.options.single.value.symbol}`)
          : $thumb.find(".value").html($etarget.val());
      });
    }
      ...
      this.$range.on("mousemove touchmove", (e) => {
        ...
        if (this.rangeMousedown) {
          ...
          this.options.direction === "horizontal"
            ...
            : (offset = $etarget.offset().left);
          this.options.direction === "horizontal"
            ? $thumb.addClass("active thumb-horizontal")
    ...
    multiRangeValue() {
      if (
        this.options.single.countingTarget !== null &&
        this.options.single.countingTarget !== undefined &&
        this.options.single.countingTarget !== "" &&
        this.options.single.counting === true
      ) {
        const $orginalTarget = $(
          `${[...this.options.single.countingTarget.split(" ")]}`
        );

        this.$range.on("input mousedown touchstart", () => {
          if (
            this.options.single.value !== undefined &&
            !$orginalTarget.is("input")
          ) {
            $orginalTarget.html(
              `${this.$range.val()} ${this.options.single.value.symbol}`
            );
    ...
    inputMultiRange() {
      if (
        this.options.single.multi !== undefined &&
        this.options.single.active === true &&
        this.options.single.multi.rangeLength >= 1
      ) {
        for (let i = 0; i < this.options.single.multi.rangeLength; i++) {
          const $ghost = this.$range
            .clone(true, true)
            .prop("id", this.randomLetter(10));

          if (
            this.options.single.multi.bgThumbColor !== undefined &&
            this.options.single.multi.textThumbColor !== undefined &&
            this.options.single.multi.bgThumbColor.length > 1
          ) {
            $ghost.attr({
              "data-color":
                this.options.single.multi.bgThumbColor.length > 1
                  ? [...this.options.single.multi.bgThumbColor][i]
                  : [...this.options.single.multi.bgThumbColor][0],
              "data-text-color":
                this.options.single.multi.textThumbColor.length > 1
                  ? [...this.options.single.multi.textThumbColor][i]
                  : [...this.options.single.multi.textThumbColor][0],
            });
          } else {
            $ghost.attr({
              "data-color": [],
          ...
          $ghost.attr({
            step:
              this.options.single.multi.value !== undefined
                ? this.options.single.multi.value.step
                : null,
            symbol:
              this.options.single.multi.value !== undefined
                ? this.options.single.multi.value.symbol
                : null,
          });
          ...
          $ghost
            .prev()
            .css("background-color", this.options.single.multi.bgThumbColor);
          this.$range.after($ghost);

          if (
            this.options.single.multi.countingTarget !== null &&
            this.options.single.multi.countingTarget !== undefined &&
            typeof this.options.single.multi.countingTarget === "object" &&
            this.options.single.multi.counting
          ) {
            const $ghostTargetValue = $(
              `${
                Object.values([...this.options.single.multi.countingTarget])[i]
              }`
            );
            ...
            $ghost.on("input mousedown", (e) => {
              if (
                this.options.single.multi.value !== undefined &&
                !$ghostTargetValue.is("input")
              ) {
                $ghostTargetValue.html(
                  `${$(e.target).val()} ${
                    this.options.single.multi.value.symbol
                  }`
                );
