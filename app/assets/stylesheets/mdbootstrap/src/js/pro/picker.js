...
(function (factory) {
  ...
  function PickerConstructor(ELEMENT, NAME, COMPONENT, OPTIONS) {
    ...
    function createWrappedComponent() {
      ...
      return `<div class="${
        CLASSES.holder
      } ${SETTINGS.inline ? "inline" : ""}" tabindex="-1">
    ...
    function prepareElementHolder() {
      P.$holder
        ...
        .on(
          "click",
          "[data-pick], [data-nav], [data-clear], [data-close], [data-select-year]",
          function (e) {
            var $target = $(this),
            ...
            // If something is picked, set `select` then close with focus.
              ...
              if (
                ...
                P.component.item.currentView === "days"
              ) {
                P.close(true);
              } else {
